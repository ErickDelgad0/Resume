...
<div class="col-lg-8 mx-auto p-4 py-md-5">
  ...
  <main>
    <h1 class="text-body-emphasis">Starpoint</h1>
    <p class="fs-5 col-md-8">Read or Download the thesis paper to get started.</p>

    <div class="mb-5">
      <a href="../includes/I_S_Final_Draft.pdf" class="btn btn-primary btn-lg px-4" download="Starpoint_Thesis.pdf">Download Thesis</a>
      <a href="starpoint-thesis.php" class="btn btn-primary btn-lg px-4" target="_blank">PDF - View</a>
    </div>
   ...
   <div class="text-center">
        <img src="../img/Starpoint-Full.png" alt="Image" class="img-fluid full-screen-image">
    </div>
  </main>
</div>
